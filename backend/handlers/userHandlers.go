...
func RegisterHandler(w http.ResponseWriter, r *http.Request) {
	...
	if userByNickname == nil && userByEmail == nil {
...
func decodeUserBody(r *http.Request, target *database.User) error {
	...
	if err != nil {
		...
		f, err := os.OpenFile("../frontend/public/"+handler.Filename, os.O_WRONLY|os.O_CREATE, 0666)
		if err != nil {
			return err
		}
		...
		target.AvatarPath = "/" + handler.Filename
	}
...
func decodeCommentBody(r *http.Request, target *database.Comment) error {
	...
	if err != nil {
		...
		target.ImagePath = "/" + handler.Filename
	}
	//read form
